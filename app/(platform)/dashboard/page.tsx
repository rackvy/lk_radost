...
async function getData(uuid: string) {
    const res = await fetch('https://backend-dolshik.shelikhov.me/api/user/get_user?id='+uuid);
    return res.json()
}
const DealBanner = () => {
    return (
...
export default async function DashboardPage() {
    ...
    return (
        <div className="" data-id={user.ID}>
            <DealsTemplate data={user.DEAL} />
